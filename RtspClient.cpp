...
CustomRTSPClient* CustomRTSPClient::createNew(RtspSession *session, UsageEnvironment& env,
...
CustomRTSPClient::CustomRTSPClient(RtspSession *session, UsageEnvironment& env,
                                    char const* rtspURL, int verbosityLevel,
                                    char const* applicationName, portNumBits tunnelOverHTTPPortNum)
